...
if not logger.handlers:
    ...
    file_handler = logging.FileHandler(LOG_DIR / "J8MS_A8MS_USERNAME_errors.log", encoding="utf-8")
...
while True:
    try:
        ...
        # IBS J8M MY
        print("\n>>== IBS J8M MY ==<<")
        mongodb_2_gs.upload_to_google_sheet_DL_USERNAME("J8M_DL_USERNAME", "1AYQ4vcayP7GLdAP0vdeaxhO64n52V6OqhSgCF7MOKXE", "Deposit List", "A", "C")
        ...
        # msg = f"\n{Style.BRIGHT}{Fore.YELLOW}Getting {Fore.GREEN}[J8M XY] {Fore.YELLOW} DEPOSIT LIST Data... (USERNAME){Style.RESET_ALL}\n"
        # for ch in msg:
        #     sys.stdout.write(ch)
        #     sys.stdout.flush()
        #     time.sleep(0.01)
        ...
        # # IBS J8M MY
        # print("\n>>== IBS J8M MY ==<<")
        # mongodb_2_gs.upload_to_google_sheet_DL_USERNAME("J8M_DL_USERNAME", "1wNxpSRskLk6F1TkyzcToQfSuEUXTc0VmO5M-_eyMZDo", "Deposit List", "A", "C")
