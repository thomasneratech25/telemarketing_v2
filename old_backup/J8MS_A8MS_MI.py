...
class Automation:
    ...
    def chrome_CDP(cls):
        ...
        # User Profile
        USER_DATA_DIR = f"/Users/nera_thomas/Library/Application Support/Google/Chrome/Profile 11"
...
class Fetch(Automation, BO_Account, mongodb_2_gs):
    ...
    def ssbo_member_info(cls, merchants, currency, collection, gs_id, gs_tab, extra_mongo_collections=None):
        ...
        while True:
            ...
            "refCode": None,
            "fingerprint": None,
            "created_date_from": f"2025-12-31T16:00:00.000Z",
