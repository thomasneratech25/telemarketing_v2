        ...
        for row in rows:
            ...
            if lastModifiedDate:
                try:
                    ...
                    # Convert UTC → GMT+7 (Bangkok Time)
...
while True:
    try:
        ...
        # safe_call(Fetch.allmemberReport, "IBS GT AMR", "gcwin99bo.com", "gc99", "THB", "+08:00", "GT_AMR_DEC25", "1GyBG3ja6q3036mQNu-BAZzmBocNjZXV_cT7VH1cUbBY", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS N855T AMR", "f5x3n8v.com", "n855", "THB", "+08:00", "N855T_AMR_DEC25", "1mZlMuGbW-uMGgS36ALMf40PefP3fhnP10LbBevmTjO4", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS N1T AMR", "m8b4x1z6.com", "n191", "THB", "+08:00", "N1T_AMR_DEC25", "1AxSnwAYKRUaqrnsufzmSjZyFd2rUIn5TF-x_HxYpF14", "TM - All Member Report")
        ...
        safe_call(Fetch.allmemberReport, "IBS N789T AMR", "q2n5w3z.com", "n789", "THB", "+08:00", "N789T_AMR_DEC25", "1-8Y2BfWJQF7lR509pIg5iZmr6FUYeGNdnP01ustVvrI", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS S8T AMR", "siam855bo.com", "s855", "THB", "+08:00", "S8T_AMR_DEC25", "1Xo2UckuthtbOdRL37lZjcTUNGFIuFXT2B-bJylZ_tE0", "TM - All Member Report")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S6T ALL MEMBER REPORT & DEPOSIT LIST -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # S6T (ALL MEMBER INFO) PUI
        # safe_call(Fetch.allmemberReport, "IBS S6T AMR", "siam66bo.com", "s66", "THB", "+08:00", "S6T_AMR_DEC25", "1PnqwIfTpPh2bhzPDOBhr-8DI6XJf8Gr1_pRlx_4vYiw", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS 2WT AMR", "w8c4n9be.com", "22w", "THB", "+08:00", "2WT_AMR_DEC25", "1NsXuxKmvuIIvDJtI5JNxG1jk-SpgTKI_e_bi-PsORlY", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS 2FT AMR", "22funbo.com", "22f", "THB", "+08:00", "2FT_AMR_DEC25", "15Sj7t9l0UlJ9EX45XJ7tkQSHDSKHO4YctJ69GXvPOe0", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS S2T AMR", "m3v5r6cx.com", "s212", "THB", "+08:00", "S2T_AMR_DEC25", "1VoeqtsxTyhf9RssP1IJjYwHCRd4w4cEzNyegsah_F_E", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS M1T AMR", "zupra7x.com", "mf191", "THB", "+08:00", "M1T_AMR_DEC25", "118lkH8_xE3cIlfehuUKU_weFN-8qOtL58pSNf8u4AvA", "TM - All Member Report")
        ...
        # safe_call(Fetch.allmemberReport, "IBS S345T AMR", "57249022.asia", "s345", "THB", "+08:00", "S345T_AMR_DEC25", "1CzV6FC8OuuoncLc86hwCGFZ2RmwMAlHFGr8IqnrTA1I", "TM - All Member Report")
