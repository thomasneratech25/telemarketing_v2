...
while True:
    try:
        ...
        print("\n\033[1;36mSSBO A8M MY\033[0m \033[2m(ANGIE)\033[0m \033[1;36mLM AMR\033[0m")
        safe_call(Fetch.ssbo_allmemberReport, "Acewin8", "Malaysia", "SSBO_A8M_LM_AMR", "LM - All Member Report (SS)", "1xodhapPpnOHXgFWYGuG6fWCGoVKUZ6Y_hC5HmpvMdzg")

        print("\n033[1;36mSSBO A8M MY\033[0m \033[2m(ANGIE 2)\033[0m \033[1;36mLM AMR\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_SSBO_AMR, "SSBO_A8M_LM_AMR", "LM - All Member Report (SS)", "1e-Fhwyc0yON1IBnzyHmBITujmSzZdci1rzOzL4urXa4")

        print("\n\033[1;36mSSBO A8M MY\033[0m \033[2m(AVA)\033[0m \033[1;36mLM AMR\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_SSBO_AMR, "SSBO_A8M_LM_AMR", "LM - All Member Report (SS)", "1PZ0OMMEV_p-wyPv_Sk2D1nNABlDGlUGMI-U-kfjt0as")

        print("\n\033[1;36mSSBO A8S SG\033[0m \033[2m(AVA)\033[0m \033[1;36mLM AMR\033[0m")
        safe_call(Fetch.ssbo_allmemberReport, "Acewin8", "Singapore", "SSBO_A8S_LM_AMR", "LM - All Member Report (SS)", "1b2yE7mdtxXxa-lLhgGX_ciVHIyWTzy4MUgMfHnHDqRk")

        print("\n\033[1;36mSSBO A8S SG\033[0m \033[2m(CINDY)\033[0m \033[1;36mLM AMR\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_SSBO_AMR, "SSBO_A8S_LM_AMR", "LM - All Member Report (SS)", "1UMz3hMfPhvfrZaudJvkYI8gjh1_GOXI6a2ZlibeFAL0")

        print("\n\033[1;36mSSBO A8T THAI\033[0m \033[2m(VIEW, TIP, KUNG)\033[0m \033[1;36mLM AMR\033[0m")
        safe_call(Fetch.ssbo_allmemberReport, "Acewin8", "Thailand", "SSBO_A8T_LM_AMR", "LM - All Member Report", "1sJkHxS9PUUrNAjxPwcsb5FVvQgAS6o1LiqG2gOeWJIg")
