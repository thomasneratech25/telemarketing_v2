...
while True:
    try:
        ...
        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=
        # ================================== SSBO IBS J8M DEPOSIT LIST ========================================================================
        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=

        print("\n\033[1;36mIBS J8M MY\033[0m \033[2m(AVA)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(Fetch.deposit_list_USERNAME, "jw8bo.com", "jw8", "J8M", "MYR", "+08:00", "J8M_DL_USERNAME", "1Za_zlpRLq9fJDB7m7WWq5ob9G7fG_gPG57kSYcBI9u0", "Deposit List", "A", "C")

        print("\n\033[1;36mIBS J8M MY\033[0m \033[2m(EUNICE)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_USERNAME, "J8M_DL_USERNAME", "1GS7Hz4r0eO3dwxHS2q_AZ5f5Oj3ABJvLYf56oPXxE9w", "Deposit List", "A", "C")

        print("\n\033[1;36mIBS J8M MY\033[0m \033[2m(XY)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_USERNAME, "J8M_DL_USERNAME", "16qAza8NdLf_0OhlXEC-JxMNtzE1DHPWwCnx95A0FOcI", "Deposit List", "A", "C")

        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=
        # ================================ SSBO IBS J8S DEPOSIT LIST ========================================================================
        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=

        print("\n\033[1;36mIBS J8S SG\033[0m \033[2m(CINDY)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(Fetch.deposit_list_USERNAME, "jw8bo.com", "jw8", "J8S", "SGD", "+08:00", "J8S_DL_USERNAME", "1rB2VCsI4mw_alo5rEiofLv8sJ6TBNh-9IUcBNv6Dcno", "Deposit List", "A", "C")

        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=
        # ================================ SSBO IBS A8M DEPOSIT LIST ========================================================================
        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=

        print("\n\033[1;36mSSBO A8M MY\033[0m \033[2m(ANGIE)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_ssbo_DL_PID, "SSBO_A8M_DL", "1xodhapPpnOHXgFWYGuG6fWCGoVKUZ6Y_hC5HmpvMdzg", "Deposit List", "A", "C")
        
        print("\n\033[1;36mIBS A8M MY\033[0m \033[2m(ANGIE)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(Fetch.deposit_list_USERNAME, "aw8bo.com", "aw8", "A8M", "MYR", "+08:00", "A8M_DL_USERNAME", "1xodhapPpnOHXgFWYGuG6fWCGoVKUZ6Y_hC5HmpvMdzg", "Deposit List", "E", "G")

        print("\n\033[1;36mSSBO A8M MY\033[0m \033[2m(ANGIE 2)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_ssbo_DL_PID, "SSBO_A8M_DL", "1e-Fhwyc0yON1IBnzyHmBITujmSzZdci1rzOzL4urXa4", "Deposit List", "A", "C")
        
        print("\n\033[1;36mIBS A8M MY\033[0m \033[2m(ANGIE 2)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_USERNAME, "A8M_DL_USERNAME", "1e-Fhwyc0yON1IBnzyHmBITujmSzZdci1rzOzL4urXa4", "Deposit List", "E", "G")

        print("\n\033[1;36mSSBO A8M MY\033[0m \033[2m(AVA)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_ssbo_DL_PID, "SSBO_A8M_DL", "1PZ0OMMEV_p-wyPv_Sk2D1nNABlDGlUGMI-U-kfjt0as", "Deposit List", "A", "C")
        
        print("\n\033[1;36mIBS A8M MY\033[0m \033[2m(AVA)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_USERNAME, "A8M_DL_USERNAME", "1PZ0OMMEV_p-wyPv_Sk2D1nNABlDGlUGMI-U-kfjt0as", "Deposit List", "E", "G")

        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=
        # ================================ SSBO IBS A8S DEPOSIT LIST ========================================================================
        # =-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=

        print("\n\033[1;36mSSBO A8S SG\033[0m \033[2m(AVA)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_ssbo_DL_PID, "SSBO_A8S_DL", "1b2yE7mdtxXxa-lLhgGX_ciVHIyWTzy4MUgMfHnHDqRk", "Deposit List", "A", "C")
        
        print("\n\033[1;36mIBS A8S SG\033[0m \033[2m(AVA)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(Fetch.deposit_list_USERNAME, "aw8bo.com", "aw8", "A8S", "SGD", "+08:00", "A8S_DL_USERNAME", "1b2yE7mdtxXxa-lLhgGX_ciVHIyWTzy4MUgMfHnHDqRk", "Deposit List", "E", "G")

        print("\n\033[1;36mSSBO A8S SG\033[0m \033[2m(CINDY)\033[0m\033[1;36m DL USERNAME\033[0m")
        safe_call(mongodb_2_gs.upload_to_google_sheet_ssbo_DL_PID, "SSBO_A8S_DL", "1UMz3hMfPhvfrZaudJvkYI8gjh1_GOXI6a2ZlibeFAL0", "Deposit List", "A", "C")
