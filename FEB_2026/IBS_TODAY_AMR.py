...
class Fetch(BO_Account, gs_helpers):
    ...
    def allmemberReport(cls, team, bo_link, bo_name, currency, gmt_time, g_sheet_ID, g_sheet_tab):
        ...
        msg = f"\n{Style.BRIGHT}{Fore.YELLOW}Getting {Fore.GREEN} {team} {Fore.YELLOW} TODAY AMR DATA...{Style.RESET_ALL}\n"
        for ch in msg:
            sys.stdout.write(ch)
            sys.stdout.flush()
            time.sleep(0.01)
        ...
        while True:
            ...
            payload = {
                "paginate": paginate,
                "page": page,
                "from_date": f"{today}T00:00:00+08:00",
...
while True:
    try:
        ...
        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS GT TODAY ALL MEMBER REPORT-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # GT (ALL MEMBER INFO) KOI
        # safe_call(Fetch.allmemberReport, "IBS GT", "gcwin99bo.com", "gc99", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS N855T TODAY ALL MEMBER REPORT-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # N855T (ALL MEMBER INFO) JIRAPORN
        # safe_call(Fetch.allmemberReport, "IBS N855T", "f5x3n8v.com", "n855", "THB", "+08:00", "", "TODAY AMR")
    
        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS N1T TODAY ALL MEMBER REPORT-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # N1T (ALL MEMBER INFO) SUPATTA
        # safe_call(Fetch.allmemberReport, "IBS N1T", "m8b4x1z6.com", "n191", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS N789T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # N789T (ALL MEMBER INFO) SUPATTA
        # safe_call(Fetch.allmemberReport, "IBS N789T", "q2n5w3z.com", "n789", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S8T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # S8T (ALL MEMBER INFO) MIN
        # safe_call(Fetch.allmemberReport, "IBS S8T", "siam855bo.com", "s855", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S6T TODAY MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # S6T (ALL MEMBER INFO) PU
        # safe_call(Fetch.allmemberReport, "IBS S6T", "siam66bo.com", "s66", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS 2WT TODAY MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # 2WT (ALL MEMBER INFO) SATANG
        # safe_call(Fetch.allmemberReport, "IBS 2WT", "w8c4n9be.com", "22w", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS 2FT TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # 2FT (ALL MEMBER INFO) NING
        # safe_call(Fetch.allmemberReport, "IBS 2FT", "22funbo.com", "22f", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S2T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # S2T (ALL MEMBER INFO) BOOM
        # safe_call(Fetch.allmemberReport, "IBS S2T", "m3v5r6cx.com", "s212", "THB", "+08:00", "", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS M1T TODAY ALL MEMBER REPORT _-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # M1T (ALL MEMBER INFO) KAEO
        # safe_call(Fetch.allmemberReport, "IBS M1T", "zupra7x.com", "mf191", "THB", "+08:00", "", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J8T (ALL MEMBER INFO) TIP
        safe_call(Fetch.allmemberReport, "IBS J8T", "jw8bo.com", "jw8", "THB", "+08:00", "1BT35DlrXVhMxI5h2BTTa6wDoqHWkOk264BOxlLf1wBc", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS MST TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # MST (ALL MEMBER INFO) POP
        safe_call(Fetch.allmemberReport, "IBS MST", "bo-msslot.com", "slot", "THB", "+08:00", "16IZ0K_qin81t-SWlmKAuDLXl7IZPsvP4Bhs2lRfdbIQ", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS I8T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # I8T (ALL MEMBER INFO) KUNG
        safe_call(Fetch.allmemberReport, "IBS I8T", "i828.asia", "828", "THB", "+08:00", "1yZ892mseBMkddq6JuFJtI_THMyxUD1rBejhXJUu6nw4", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS G855T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # G855T (ALL MEMBER INFO) VIEW
        safe_call(Fetch.allmemberReport, "IBS G855T", "god855.asia", "g855", "THB", "+08:00", "1kJVDdpS3rAG9f31nk96HUloT1RJspu5oOSY-Txd7Wfs", "TODAY AMR")

        # # # =============================================================================================================================
        # # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S345T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # # =============================================================================================================================

        # # S345T (ALL MEMBER INFO) BUA
        # safe_call(Fetch.allmemberReport, "IBS S345T", "57249022.asia", "s345", "THB", "+08:00", "", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS A8N TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # A8N (ALL MEMBER INFO) ANNA
        safe_call(Fetch.allmemberReport, "IBS A8N", "aw8bo.com", "aw8", "NPR", "+08:00", "1kw12XtEgWJpUzvNpl9IwRrc66OiWWwCXkGfPbJ_nmL0", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J1B TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================
        ...
        safe_call(Fetch.allmemberReport, "IBS I8N", "6668889.site", "i88", "NPR", "+08:00", "1-7UObibmsw2vNogMyXhnaP2SDP56iwPgYIeG-5zJ3jc", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J1N TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J1N (ALL MEMBER INFO) LAXMI
        safe_call(Fetch.allmemberReport, "IBS J1N", "batsman88.com", "jaya11", "NPR", "+08:00", "1to0EnUiUirgAzmF-cUwHFRLYPGO3OeL8tqWxqaafhC8", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8N TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J8N (ALL MEMBER INFO) SIJAPATI
        safe_call(Fetch.allmemberReport, "IBS J8N", "jw8bo.com", "jw8", "NPR", "+08:00", "11IIc3Y1aS6DcQTyITraQCT9jC5dekfwfScwocWWL7FA", "TODAY AMR")
        
        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8B TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # J8B (ALL MEMBER INFO) ALI
        # safe_call(Fetch.allmemberReport, "IBS J8B", "jw8bo.com", "jw8", "BDT", "+08:00", "", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS K8N TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # K8N (ALL MEMBER INFO) HIMANI
        safe_call(Fetch.allmemberReport, "IBS K8N", "6668889.store", "k88", "NPR", "+08:00", "1gmzY97EWfOdo-3c1Lmvt15aInG6PdUSavnzattkOamc", "TODAY AMR")

        # # =============================================================================================================================
        # # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS D8M TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # # =============================================================================================================================

        # # D8M (ALL MEMBER INFO) RY
        # safe_call(Fetch.allmemberReport, "IBS D8M", "dis88bo.com", "dis88", "MYR", "+08:00", "", "TODAY AMR")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS R99T TODAY ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # R99T (POP)
        safe_call(Fetch.allmemberReport, "IBS R99T", "bex7tor.com", "r99", "THB", "+08:00", "1RtAI_Z3qPe3O_cw7AnP9x0geUuzlEd7Kr0primEolRU", "TODAY AMR")
