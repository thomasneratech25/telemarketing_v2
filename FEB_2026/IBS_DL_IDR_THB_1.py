...
while True:
    try:
        ...
        # S5T (DEPOSIT LIST)
        safe_call(Fetch.deposit_list_PID, "s55bo.com", "s55", "S5T", "THB", "+07:00", "S55_S5T_DL", "1M4d7S2IpcUokUF3RsDQAMGFaVRKs4y21zwdyiTgk12o", "DEPOSIT LIST", "A", "C", description="S5T deposit list")
        ...
        # LIN
        safe_call(Fetch.deposit_list_PID, "57249022.asia", "s345", "S345T", "THB", "+07:00", "S345_S345T_DL", "11Kz5AOzFR92S_bpRsKBBt_b-VGsj2NztzQe96uUIUzo", "DEPOSIT LIST", "A", "C", description="S345T deposit list")

        # JANE
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S345_S345T_DL", "1ZLtw9x1PRwQkVQkkm9ijfquwCuk3s4IqKV6cjdQ5X4s", "DEPOSIT LIST", "A", "C")

        # BUA
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S345_S345T_DL", "1bSWCe1ejtv_dMXJPUWxqlvxYXWId_9J1Ddb5cwBOlKE", "Deposit List", "A", "C")
        ...
        # YOD
        safe_call(Fetch.deposit_list_PID, "m3v5r6cx.com", "s212", "S2T", "THB", "+07:00", "S212_S2T_DL", "1ijEyJn06GLt2b62OpFuKIvfB0E5Z2B76kZ4vw5FFW-A", "DEPOSIT LIST", "A", "C", description="S2T deposit list")

        # CHING
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S212_S2T_DL", "1lEa0Oh475S0DCn6ihtJie0vd1Jp5l5-8e782GQDe7o4", "DEPOSIT LIST", "A", "C", description="S2T deposit list")

        # CHING
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S212_S2T_DL", "1hXcxpefr2DdMdprn5RnTVmfRZrUBgeIh_phTYuJysvI", "Deposit List", "A", "C", description="S2T deposit list")
        ...
        safe_call(Fetch.deposit_list_PID, "uhy3umx.com", "s369", "S369T", "THB", "+07:00", "S369_S369T_DL", "11HL1lEyeqoiEwbJMPIamWDoDwRZXPpuMnWyCh7RtL0M", "DEPOSIT LIST", "A", "C", description="S369T deposit list")

        # S369T (DEPOSIT LIST) MINT
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S369_S369T_DL", "1Ago96LTdNdQBaVBMzjbMlnN3KdDgTJDbqxMv6Imxuq0", "DEPOSIT LIST", "A", "C", description="S369T deposit list")
        ...
        # HOM
        safe_call(Fetch.deposit_list_PID, "siam66bo.com", "s66", "S6T", "THB", "+07:00", "S66_S6T_DL", "1FeDA1z2hL9Uk7Vna2nt5HuNxIHnEGZRzRQoA1O4IcD0", "DEPOSIT LIST", "A", "C", description="S6T deposit list")

        # MEI
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S66_S6T_DL", "1H8xyXdffyBeHzdHtDiLHdnC8gYrefog1kALBswBTuuQ", "DEPOSIT LIST", "A", "C", description="S6T deposit list")
        
        # MEI
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S66_S6T_DL", "1jUdIWWG_PYZKLVDLKnDzgT-T7BVCld6REp42T9NXaBA", "DEPOSIT LIST", "A", "C", description="S6T deposit list")
        ...
        safe_call(Fetch.deposit_list_PID, "jw8bo.com", "jw8", "J8T", "THB", "+07:00", "JW8_J8T_DL", "1vcH2zmeJ1bIvup-pmcHR9J5dlzsCaJg9hf9Jr7C5OZg", "DEPOSIT LIST", "A", "C", description="J8T deposit list")

        # J8T (DEPOSIT LIST) TIP
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "JW8_J8T_DL", "1BT35DlrXVhMxI5h2BTTa6wDoqHWkOk264BOxlLf1wBc", "DEPOSIT LIST", "A", "C", description="J8T deposit list")

        # J8T (DEPOSIT LIST) TIP
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "JW8_J8T_DL", "1A-wZ5lM2BQtzy2k3VakjdiQ6rmFTbYs__k-1q0Olwy0", "DEPOSIT LIST", "A", "C", description="J8T deposit list")
        ...
        # FON
        safe_call(Fetch.deposit_list_PID, "bo-msslot.com", "slot", "MST", "THB", "+07:00", "SLOT_MST_DL", "1gmvtZ05WTC4lu60rmnSATBYQGxF9e4HS8s-9u3HsgBg", "DEPOSIT LIST", "A", "C", description="MST deposit list")

        # VIEW, TIP, KUNG
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "SLOT_MST_DL", "1c6MGI58VEhU2hO4K7T1PZmFGNRTgLoTuDBwlKXmpXuw", "DEPOSIT LIST", "A", "C", description="MST deposit list")

        # VIEW, TIP, KUNG
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "SLOT_MST_DL", "16IZ0K_qin81t-SWlmKAuDLXl7IZPsvP4Bhs2lRfdbIQ", "DEPOSIT LIST", "A", "C", description="MST deposit list")
        ...
        # TATA
        safe_call(Fetch.deposit_list_PID, "i828.asia", "828", "I8T", "THB", "+07:00", "I828_I8T_DL", "1ZrIrFBaBsiliGFMfVeO5Kq5ExnC5nJfTk7i3FI5S-UU", "DEPOSIT LIST", "A", "C", description="I8T deposit list")

        # VIEW, TIP, KUNG
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "I828_I8T_DL", "1yZ892mseBMkddq6JuFJtI_THMyxUD1rBejhXJUu6nw4", "DEPOSIT LIST", "A", "C", description="I8T deposit list")

        # VIEW, TIP, KUNG
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "I828_I8T_DL", "1-AGWwQH6u8wZxbf5un4cfav2KTBvxLy-ET-qwpfBwm4", "DEPOSIT LIST", "A", "C", description="I8T deposit list")
