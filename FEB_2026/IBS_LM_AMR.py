...
class Fetch(BO_Account, gs_helpers):
    ...
    def allmemberReport(cls, team, bo_link, bo_name, currency, gmt_time, g_sheet_ID, g_sheet_tab, upload=True):
        ...
        msg = f"\n{Style.BRIGHT}{Fore.YELLOW}Getting {Fore.GREEN} {team} {Fore.YELLOW} LM AMR DATA...{Style.RESET_ALL}\n"
        for ch in msg:
            sys.stdout.write(ch)
            sys.stdout.flush()
            time.sleep(0.01)
        ...
        while True:
            ...
            payload = {
                "paginate": paginate,
                "page": page,
                "from_date": f"{first_day_last_month_str}T00:00:00+08:00",
                "to_date": f"{last_day_last_month_str}T23:59:59+08:00",
                "currency": [currency],
                "merchant_id": 1,
                "admin_id": 295,
                "aid": 295
...
while True:
    try:
        ...
        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS GT LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # GT (ALL MEMBER INFO) KOI
        safe_call(Fetch.allmemberReport, "IBS GT", "gcwin99bo.com", "gc99", "THB", "+08:00", "1lFrK5k8oRIW1e4aFtaLTB4dGtLnVgtwtlfMKQdtFqrc", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS N855T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # JIRAPORN
        safe_call(Fetch.allmemberReport, "IBS N855T", "f5x3n8v.com", "n855", "THB", "+08:00", "1f1k9D-IKdL8qyoQyLLBPi_ww-cTRJV4-S1B3B4lkrKM", "LM - All Member Report")
    
        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS N1T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # SUPATTA
        safe_call(Fetch.allmemberReport, "IBS N1T", "m8b4x1z6.com", "n191", "THB", "+08:00", "1tlFaPMptGcwFEp1dtzBqSTz5R8ofWhOcasYi5QBphCI", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS N789T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # N789T (ALL MEMBER INFO) SUPATTA
        safe_call(Fetch.allmemberReport, "IBS N789T", "q2n5w3z.com", "n789", "THB", "+08:00", "1H1PKac3Hd9dcIS-dTLBFMDKsCQBYUzX6PG9YCJ7hu_Y", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S8T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # S8T (ALL MEMBER INFO) MIN
        safe_call(Fetch.allmemberReport, "IBS S8T", "siam855bo.com", "s855", "THB", "+08:00", "1MOCaMD48nxSyBMVG0O01kKL4c5KxGJz71gb5nTpVvxo", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S6T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # S6T (ALL MEMBER INFO) PU
        safe_call(Fetch.allmemberReport, "IBS S6T", "siam66bo.com", "s66", "THB", "+08:00", "1jUdIWWG_PYZKLVDLKnDzgT-T7BVCld6REp42T9NXaBA", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS 2WT LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # 2WT (ALL MEMBER INFO) SATANG
        safe_call(Fetch.allmemberReport, "IBS 2WT", "w8c4n9be.com", "22w", "THB", "+08:00", "1JgEWHohCHU-SYtY4IMVnuTTfMIYartGEuXSllLawmto", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS 2FT LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # 2FT (ALL MEMBER INFO) NING
        safe_call(Fetch.allmemberReport, "IBS 2FT", "22funbo.com", "22f", "THB", "+08:00", "1cTUwdSANPnmtLOeUd1TG6MrcF1OnJ2y2TLvAeaJ8Cww", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S2T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # CHING
        safe_call(Fetch.allmemberReport, "IBS S2T", "m3v5r6cx.com", "s212", "THB", "+08:00", "1hXcxpefr2DdMdprn5RnTVmfRZrUBgeIh_phTYuJysvI", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS M1T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # KAEO
        safe_call(Fetch.allmemberReport, "IBS M1T", "zupra7x.com", "mf191", "THB", "+08:00", "1ccQ9N4kv9cyS9dBcmTw1jN_vY9pXBxq9RdFKmRVmp5I", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J8T (ALL MEMBER INFO) TIP
        safe_call(Fetch.allmemberReport, "IBS J8T", "jw8bo.com", "jw8", "THB", "+08:00", "1BT35DlrXVhMxI5h2BTTa6wDoqHWkOk264BOxlLf1wBc", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8M LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # AVA
        j8m_rows = safe_call(Fetch.allmemberReport, "IBS J8M", "jw8bo.com", "jw8", "MYR", "+08:00", "1Za_zlpRLq9fJDB7m7WWq5ob9G7fG_gPG57kSYcBI9u0", "LM - All Member Report", upload=False)
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1Za_zlpRLq9fJDB7m7WWq5ob9G7fG_gPG57kSYcBI9u0", "LM - All Member Report", rows=j8m_rows)

        # Eunice 
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1GS7Hz4r0eO3dwxHS2q_AZ5f5Oj3ABJvLYf56oPXxE9w", "LM - All Member Report", rows=j8m_rows)
        
        # XY
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "16qAza8NdLf_0OhlXEC-JxMNtzE1DHPWwCnx95A0FOcI", "LM - All Member Report", rows=j8m_rows)
        
        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8S LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # CINDY
        j8s_rows = safe_call(Fetch.allmemberReport, "IBS J8S", "jw8bo.com", "jw8","SGD", "+08:00", "1rB2VCsI4mw_alo5rEiofLv8sJ6TBNh-9IUcBNv6Dcno", "LM - All Member Report",upload=False)
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1rB2VCsI4mw_alo5rEiofLv8sJ6TBNh-9IUcBNv6Dcno", "LM - All Member Report", rows=j8s_rows)

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS MST LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # MST (ALL MEMBER INFO) POP
        safe_call(Fetch.allmemberReport, "IBS MST", "bo-msslot.com", "slot", "THB", "+08:00", "16IZ0K_qin81t-SWlmKAuDLXl7IZPsvP4Bhs2lRfdbIQ", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS I8T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # I8T (ALL MEMBER INFO) KUNG
        safe_call(Fetch.allmemberReport, "IBS I8T", "i828.asia", "828", "THB", "+08:00", "1yZ892mseBMkddq6JuFJtI_THMyxUD1rBejhXJUu6nw4", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS G855T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # G855T (ALL MEMBER INFO) VIEW
        safe_call(Fetch.allmemberReport, "IBS G855T", "god855.asia", "g855", "THB", "+08:00", "1kJVDdpS3rAG9f31nk96HUloT1RJspu5oOSY-Txd7Wfs", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S345T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # BUA
        safe_call(Fetch.allmemberReport, "IBS S345T", "57249022.asia", "s345", "THB", "+08:00", "1bSWCe1ejtv_dMXJPUWxqlvxYXWId_9J1Ddb5cwBOlKE", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS A8N LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # A8N (ALL MEMBER INFO) ANNA
        safe_call(Fetch.allmemberReport, "IBS A8N", "aw8bo.com", "aw8", "NPR", "+08:00", "1kw12XtEgWJpUzvNpl9IwRrc66OiWWwCXkGfPbJ_nmL0", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS A8M LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # ANNA
        a8m_rows = safe_call(Fetch.allmemberReport, "IBS A8M", "aw8bo.com", "aw8", "MYR", "+08:00", "1PZ0OMMEV_p-wyPv_Sk2D1nNABlDGlUGMI-U-kfjt0as", "LM - All Member Report (IBS)", upload=False)
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1PZ0OMMEV_p-wyPv_Sk2D1nNABlDGlUGMI-U-kfjt0as", "LM - All Member Report (IBS)", rows=a8m_rows)

        # Angie
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1xodhapPpnOHXgFWYGuG6fWCGoVKUZ6Y_hC5HmpvMdzg", "LM - All Member Report (IBS)", rows=a8m_rows)
        
        # Angie2
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1e-Fhwyc0yON1IBnzyHmBITujmSzZdci1rzOzL4urXa4", "LM - All Member Report (IBS)", rows=a8m_rows)

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS A8S LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # AVA
        a8s_rows = safe_call(Fetch.allmemberReport, "IBS A8S", "aw8bo.com", "aw8", "SGD", "+08:00", "1b2yE7mdtxXxa-lLhgGX_ciVHIyWTzy4MUgMfHnHDqRk", "LM - All Member Report (IBS)", upload=False)
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1b2yE7mdtxXxa-lLhgGX_ciVHIyWTzy4MUgMfHnHDqRk", "LM - All Member Report (IBS)", rows=a8s_rows)
        
        # Cindy
        safe_call(gs_helpers.upload_to_google_sheet_AMR, "1UMz3hMfPhvfrZaudJvkYI8gjh1_GOXI6a2ZlibeFAL0", "LM - All Member Report (IBS)", rows=a8s_rows)

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J1B LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J1B (ALL MEMBER INFO) RABBY
        safe_call(Fetch.allmemberReport, "IBS J1B", "batsman88.com", "jaya11", "BDT", "+08:00", "1NaxtKUkQOsdwFmqDrv_yEnMNW9GST9GLn2_p5x0PsIw", "LM - All Member Report")
        
        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS I8N LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # I8N (ALL MEMBER INFO) LOKENDRA
        safe_call(Fetch.allmemberReport, "IBS I8N", "6668889.site", "i88", "NPR", "+08:00", "1-7UObibmsw2vNogMyXhnaP2SDP56iwPgYIeG-5zJ3jc", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J1N LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J1N (ALL MEMBER INFO) LAXMI
        safe_call(Fetch.allmemberReport, "IBS J1N", "batsman88.com", "jaya11", "NPR", "+08:00", "1to0EnUiUirgAzmF-cUwHFRLYPGO3OeL8tqWxqaafhC8", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8N LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J8N (ALL MEMBER INFO) SIJAPATI
        safe_call(Fetch.allmemberReport, "IBS J8N", "jw8bo.com", "jw8", "NPR", "+08:00", "11IIc3Y1aS6DcQTyITraQCT9jC5dekfwfScwocWWL7FA", "LM - All Member Report")
        
        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS J8B LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # J8B (ALL MEMBER INFO) ALI
        safe_call(Fetch.allmemberReport, "IBS J8B", "jw8bo.com", "jw8", "BDT", "+08:00", "15mL4VqEz1bdRfWQQBAXz8AMUofBIe3HVetl_N1hbncw", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS K8N LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # K8N (ALL MEMBER INFO) HIMANI
        safe_call(Fetch.allmemberReport, "IBS K8N", "6668889.store", "k88", "NPR", "+08:00", "1gmzY97EWfOdo-3c1Lmvt15aInG6PdUSavnzattkOamc", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS D8M LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # D8M (ALL MEMBER INFO) RY
        safe_call(Fetch.allmemberReport, "IBS D8M", "dis88bo.com", "dis88", "MYR", "+08:00", "1eGdpMBnOLCT3pE1pyWm0RS4_jyhbBZqY1ChHb_Y9rYA", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS R99T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # R99T (POP)
        safe_call(Fetch.allmemberReport, "IBS R99T", "bex7tor.com", "r99", "THB", "+08:00", "1RtAI_Z3qPe3O_cw7AnP9x0geUuzlEd7Kr0primEolRU", "LM - All Member Report")

        # =============================================================================================================================
        # -_-_-_-_-_-_-_-_-_-_-_-_-_-_  IBS S1T LM ALL MEMBER REPORT -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_
        # =============================================================================================================================

        # S1T (PHOUNG)
        safe_call(Fetch.allmemberReport, "IBS S1T", "sol9ven.com", "s191", "THB", "+08:00", "1LCOw9dCu7CW-acsIZkCEzP_DvemZEC7EeSRuZn0n2vY", "LM - All Member Report")
