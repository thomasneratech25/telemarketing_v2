...
class mongodb_2_gs:
    ...
    # MongoDB Database (ND)
    def mongodbAPI_ssbo_ND(rows, collection):
    ...
    @classmethod
    def upload_to_google_sheet_ssbo_ND(cls, collection, gs_id, gs_tab, rows=None, extra_mongo_collections=None):
...
class Fetch(BO_Account, mongodb_2_gs):
    ...
    # SSBO ND (merchants name = aw8, ip9, uea)
    @classmethod
    def ssbo_ND(cls, merchants, currency, collection, gs_id, gs_tab, extra_mongo_collections=None):
        ...
        while True:
            ...
            "refCode": None,
            "fingerprint": None,
            "created_date_from": f"{first_day_last_month_str}T17:00:00.000Z",
            "created_date": f"{last_day_last_month_str}T16:59:59.000Z",
            "registerDate": None,
            ...
            if response.status_code in (401, 403):
                ...
                cls.ssbo_ND(merchants, currency, collection, gs_id, gs_tab, extra_mongo_collections=extra_mongo_collections)
                return
            ...
            params = {
                ...
                "currencies": currency_list,
                "matchFullPhone": "true",
                "createdDateFrom": f"{first_day_last_month_str}T17:00:00.000Z",
                "createdDate": f"{last_day_last_month_str}T16:59:59.000Z",
                "complianceViewMemberSocialMediaDetails": "true",
                "enableShowTotalWallet": "false",
                "mask": "false",
                "merchants": merchants,
            ...
            if valid_rows:
                cls.mongodbAPI_ssbo_ND(valid_rows, collection)
            else:
        ...
        cls.upload_to_google_sheet_ssbo_ND(collection, gs_id, gs_tab, extra_mongo_collections=extra_mongo_collections)
