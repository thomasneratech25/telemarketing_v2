...
while True:
    try:
        ...
        # MEME
        safe_call(Fetch.deposit_list_PID, "god855.asia", "g855", "G855T", "THB", "+07:00", "G855_G855T_DL", "12AVH011V35qWUCqpMWfMpmYzhRflyaxWZ5BUCCYHWhQ", "DEPOSIT LIST", "A", "C", description="G855T deposit list")

        # VIEW, TIP, KUNG)
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "G855_G855T_DL", "1kJVDdpS3rAG9f31nk96HUloT1RJspu5oOSY-Txd7Wfs", "DEPOSIT LIST", "A", "C", description="G855T deposit list")

        # VIEW, TIP, KUNG)
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "G855_G855T_DL", "1fP0US23tZChapiQieKfRveFuG2glNUh15MPYJiC6PGQ", "Deposit List", "A", "C", description="G855T deposit list")
        ...
        # DAOW
        safe_call(Fetch.deposit_list_PID, "22funbo.com", "22f", "2FT", "THB", "+07:00", "22F_2FT_DL", "1cizS7oiv6uD9DzmdiTVhIxQ8xgnSYNMgt93RtCsGI_E", "DEPOSIT LIST", "A", "C", description="2FT deposit list")

        # MUAY
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "22F_2FT_DL", "1qvdJ_YUmFSAcJ2ENRbanZpxCNBazYT_PP-R6jz8NVqE", "DEPOSIT LIST", "A", "C", description="2FT deposit list")

        # KAEO
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "22F_2FT_DL", "1cTUwdSANPnmtLOeUd1TG6MrcF1OnJ2y2TLvAeaJ8Cww", "Deposit List", "A", "C", description="2FT deposit list")
        ...
        # ALICE
        safe_call(Fetch.deposit_list_PID, "zupra7x.com", "mf191", "M1T", "THB", "+07:00", "MF191_M1T_DL", "1t_Nz_v0e6P-_rOlN9gyqSs2ncgZeGmbJsybk5M8ayDY", "DEPOSIT LIST", "A", "C", description="M1T deposit list")
        
        # KAEO
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "MF191_M1T_DL", "1eQXzwqGE8uszuFvb19jwRq3zPYK5ojv3SCUzdQr2_vs", "DEPOSIT LIST", "A", "C", description="M1T deposit list")

        # KAEO
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "MF191_M1T_DL", "1ccQ9N4kv9cyS9dBcmTw1jN_vY9pXBxq9RdFKmRVmp5I", "Deposit List", "A", "C", description="M1T deposit list")
        ...
        # NONG SI
        safe_call(Fetch.deposit_list_PID, "w8c4n9be.com", "22w", "2WT", "THB", "+07:00", "22W_2WT_DL", "1TTd1TgPwZUX_sdQJX-CzdZM2imLZi1vLgUkBmFXgZQ8", "DEPOSIT LIST", "A", "C", description="2WT deposit list")
        
        # SAI
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "22W_2WT_DL", "JgEWHohCHU-SYtY4IMVnuTTfMIYartGEuXSllLawmto", "DEPOSIT LIST", "A", "C", description="2WT deposit list")

        # SATANG
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "22W_2WT_DL", "1H3te4ymNjPqt_yLyWbFz6HvdFWRIQP-AUYLsEqhT6_8", "Deposit List", "A", "C", description="2WT deposit list")
        ...
        # MEW
        safe_call(Fetch.deposit_list_PID, "siam855bo.com", "s855", "S8T", "THB", "+07:00", "S855_S8T_DL", "1BlvW1IwKMMHGN4n4kmh9nWZCoXHSdnn_Vw_6BT4k0Yk", "DEPOSIT LIST", "A", "C", description="S8T deposit list")

        # NINEW
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S855_S8T_DL", "1MOCaMD48nxSyBMVG0O01kKL4c5KxGJz71gb5nTpVvxo", "DEPOSIT LIST", "A", "C", description="S8T deposit list")
        
        # NINEW
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S855_S8T_DL", "16t_9zYJRynTgkzQa0AUGVsjNGIv7YSIBrOWXMXpyaOc", "DEPOSIT LIST", "A", "C", description="S8T deposit list")
        ...
        # SUPATTA
        safe_call(Fetch.deposit_list_PID, "m8b4x1z6.com", "n191", "N1T", "THB", "+07:00", "N1T_DL", "1tlFaPMptGcwFEp1dtzBqSTz5R8ofWhOcasYi5QBphCI", "Deposit List", "A", "C")

        # TANGMO
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "N1T_DL", "1wIaHLvmXPypSpW5IWpwt8ex-ESwTgD0VGmugwqPz9tw", "DEPOSIT LIST", "A", "C")

        # # PENDING
        # safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "N1T_DL", "", "DEPOSIT LIST", "A", "C")
