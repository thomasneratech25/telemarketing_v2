...
while True:
    try:
        ...
        # S345T (DEPOSIT LIST) BUA
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S345_S345T_DL", "1npR2LLvMZ4hzsdH5bjdI1zabnJy75fq9K4-gWT_xbCo", "DEPOSIT LIST", "A", "C")

        # S345T (DEPOSIT LIST) LIN
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S345_S345T_DL", "1edXU80rgIe5GYCXwnXt1tZob5hwrk17ek6Ow4gK-9pk", "DEPOSIT LIST", "A", "C")
        ...
        # S2T (DEPOSIT LIST) BOOM
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S212_S2T_DL", "1lp2eBaXG_-CfZ52OXUxtLSXoQcPeWJ6IJJ676F95K2c", "DEPOSIT LIST", "A", "C", description="S2T deposit list")
        ...
        # S6T (DEPOSIT LIST) PU
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S66_S6T_DL", "18m1h7K_AUy-dm0dhad3J4JiYEgZuzoxEbvc4BQoFcCE", "DEPOSIT LIST", "A", "C", description="S6T deposit list")
        ...
        # J8T (DEPOSIT LIST) TIP
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "JW8_J8T_DL", "1dYSGFLO9emW-BGjfxcGVC28esDld1_BYD1npK-NkUpI", "DEPOSIT LIST", "A", "C", description="J8T deposit list")
        ...
        # MST (DEPOSIT LIST) POP
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "SLOT_MST_DL", "1k70B4OniQ8_C1MzZNyGoWt0dBGJrC83n0XW0MQEEHCE", "DEPOSIT LIST", "A", "C", description="MST deposit list")
        ...
        # I8T (DEPOSIT LIST) KUNG
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "I828_I8T_DL", "12xJ4diNv1rJItUwH9XroDDesqPcffZcJL4Pw2d7rY68", "DEPOSIT LIST", "A", "C", description="I8T deposit list")
