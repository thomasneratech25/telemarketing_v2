...
while True:
    try:
        ...
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S369_S369T_DL", "1AJxM5m0yOoNk7G8e8S7OdJi2lTK0zVLoiZYGp_on1D8", "DEPOSIT LIST", "A", "C", description="S369T deposit list")
        ...
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "SLOT_MST_DL", "1D_aZd_xkUmw60RxKKMBzgKLJplxSom02nKMbUoIS-cQ", "DEPOSIT LIST", "A", "C", description="MST deposit list")
        ...
        safe_call(Fetch.member_info, "god855.asia", "g855", "G855T", "THB", "+07:00", "G855_G855T_MI", "1B37JEPVLNEcYkdLcHRghucxykBLJSUwTt9TAx5vbXc4", "New Register", description="G855T member info")
        ...
        safe_call(Fetch.member_info, "batsman88.com", "jaya11", "J1B", "BDT", "+07:00", "J1B_MI", "1rQbILhw863sXnLN0HURxcZ_UN5R3K9jdOLmXJvba2Ic", "New Register", description="IBS J1B MEMBER INFO")
        ...
        safe_call(Fetch.member_info, "batsman88.com", "jaya11", "J1N", "NPR", "+07:00", "J1N_MI", "1k3Xf32Fpl1OIjorkaVTlo5XOkuBjmUiIgFuyLxu2VW8", "New Register", description="IBS J1N MEMBER INFO")
            
        # J1N (DEPOSIT LIST) (BADAL)
        safe_call(Fetch.deposit_list_PID, "batsman88.com", "jaya11", "J1N", "NPR", "+07:00", "J1N_DL", "1k3Xf32Fpl1OIjorkaVTlo5XOkuBjmUiIgFuyLxu2VW8", "DEPOSIT LIST", "A", "C", description="J1N deposit list")
        ...
        safe_call(Fetch.member_info, "jw8bo.com", "jw8", "J8N", "NPR", "+07:00", "J8N_MI", "1k3Xf32Fpl1OIjorkaVTlo5XOkuBjmUiIgFuyLxu2VW8", "New Register", description="IBS J8N MEMBER INFO")
        ...
        # ==========================================================================
        # =-=-=-=-==-=-=-=-= I8N MEMBER INFO & DEPOSIT LIST =-=-=-=-==-=-=-=-=-=-= 
        # ==========================================================================

        # I8N (MEMBER INFO) (BHAGWATI)
        safe_call(Fetch.member_info, "6668889.site", "i88", "I8N", "NPR", "+07:00", "I8N_MI", "1hwMSZUAfFhJWj02J813cIgbXLgebHExdC-9n3YYfph4", "New Register", description="IBS I8N MEMBER INFO")
        ...
        # ==========================================================================
        # =-=-=-=-==-=-=-=-= K8N MEMBER INFO & DEPOSIT LIST =-=-=-=-==-=-=-=-=-=-= 
        # ==========================================================================

        # K8N (MEMBER INFO) (BHAGWATI)
        safe_call(Fetch.member_info, "6668889.store", "k88", "K8N", "NPR", "+07:00", "K8N_MI", "1WXQPUnWTjreq-COQpcgiSTQeD506_AFSVqbLO5nBYxc", "New Register", description="IBS K8N MEMBER INFO")
        ...
        # # A8V (MEMBER INFO) 
        # safe_call(Fetch.member_info, "aw8bo.com", "aw8", "A8V", "VND", "+07:00", "A8V_MI", "1WXQPUnWTjreq-COQpcgiSTQeD506_AFSVqbLO5nBYxc", "New Register", description="IBS A8V MEMBER INFO")
