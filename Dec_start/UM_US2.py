...
while True:
    try:
        ...
        # IBS UM MY
        safe_call(Fetch.ftd_stdReport, "29018465.asia", "uea8", "MYR", "+08:00", "UM_FTD_STD", "1ER8Ovkc563SZxJDuy1rYWJqNIgoaAkpfNeE2DWbK-Qc", "UM2", upload_to_sheet=False, description="IBS UM MY FTD/STD")
        
        # SSBO UM MY
        safe_call(Fetch.ssbo_ftd_stdReport, "uea", "MYR", "SSBO_UM_FTD_STD", "1ER8Ovkc563SZxJDuy1rYWJqNIgoaAkpfNeE2DWbK-Qc", "UM2", extra_mongo_collections=["UM_FTD_STD"], description="SSBO UM MY FTD/STD")

        # SSBO US SG
        safe_call(Fetch.ssbo_ftd_stdReport, "uea", "SGD", "SSBO_US_FTD_STD", "1ER8Ovkc563SZxJDuy1rYWJqNIgoaAkpfNeE2DWbK-Qc", "US2", description="SSBO US SG FTD/STD")
