...
class Automation:
    ...
    def chrome_CDP(cls):
        ...
        # User Profile
        USER_DATA_DIR = f"/home/thomas/.config/google-chrome/Profile 10"
        ...
        cls.chrome_proc = subprocess.Popen([
            ...
            "--force-device-scale-factor=1",     # ✅ ensure no zoom scaling
            "--no-sandbox",            # Required for running as root/CLI
