...
while True:
    try:
        ...
        # G855T (DEPOSIT LIST) MEME
        safe_call(Fetch.deposit_list_PID, "god855.asia", "g855", "G855T", "THB", "+07:00", "G855_G855T_DL", "1B37JEPVLNEcYkdLcHRghucxykBLJSUwTt9TAx5vbXc4", "DEPOSIT LIST", "A", "C", description="G855T deposit list")
        ...
        # G855T (DEPOSIT LIST) VIEW
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "G855_G855T_DL", "1Urk-Zo1xVlzeiCJF0HB0F2-n1_ptto5sTzdy4U9g3J0", "DEPOSIT LIST", "A", "C", description="G855T deposit list")
        ...
        # 2FT (DEPOSIT LIST) NING
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "22F_2FT_DL", "1YmcYjn2RaQe7b9x7UZof7V9xHwQvSR7qkSLlQPz3hSA", "DEPOSIT LIST", "A", "C", description="2FT deposit list")
        ...
        # M1T (DEPOSIT LIST) KAEO
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "MF191_M1T_DL", "1w4Yto0PDjsyYnPsLZnSm72l6bPAiwXuEJasfcld09mI", "DEPOSIT LIST", "A", "C", description="M1T deposit list")
        ...
        # 2WT (DEPOSIT LIST) SATANG
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "22W_2WT_DL", "1aShl2QYJbwy1y97nUnKPzjkjlK-JEOHl8KrhzXtbti0", "DEPOSIT LIST", "A", "C", description="2WT deposit list")
        ...
        # S8T (DEPOSIT LIST) MIN
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "S855_S8T_DL", "1qdu-hI9yitWLKuFUVVAK7LLVfW7DbPelGDmk-VuU7s4", "DEPOSIT LIST", "A", "C", description="S8T deposit list")

        # ==========================================================================
        # =-=-=-=-==-=-=-=-= N789T DEPOSIT LIST =-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=
        # ==========================================================================

        # N789T (DEPOSIT LIST) SUPATTA
        safe_call(Fetch.deposit_list_PID, "q2n5w3z.com", "n789", "N789T", "THB", "+07:00", "N789T_DL", "1Aubkpmr1ViquwVgIoA87T--mVjd5bl4zCJLPo03Hxgk", "Deposit List", "A", "C")

        # N789T (DEPOSIT LIST) TOKIE
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "N789T_DL", "1WpAC5wQZ06TSJwfg6UmZzJoj5qJX4P7FkZh3ekhR-GQ", "DEPOSIT LIST", "A", "C")

        # N789T (DEPOSIT LIST) AUGUST
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "N789T_DL", "1cckX4TgyUQDAV5O06yiO1Zfo9ARwT1aH6vwaUcLgNNg", "DEPOSIT LIST", "A", "C")

        # ==========================================================================
        # =-=-=-=-==-=-=-=-= N1T DEPOSIT LIST =-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-= 
        # ==========================================================================

        # N1T (DEPOSIT LIST) SUPATTA
        safe_call(Fetch.deposit_list_PID, "m8b4x1z6.com", "n191", "N1T", "THB", "+07:00", "N1T_DL", "19yThSHpDPkXsjI_q-1X1CKhLS_p5BIS9Hk8Qn9fTGfE", "Deposit List", "A", "C")

        # N1T (DEPOSIT LIST) NAREM
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "N1T_DL", "1z5cQal2mTKfm94Xx01Kt9yB2Cq90E9SKeGURcp5u7r8", "DEPOSIT LIST", "A", "C")

        # N1T (DEPOSIT LIST) August
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "N1T_DL", "1x7xS28Lmx4Y89qoN7SbSwoudf360iw2uVVjCAo0Oza8", "DEPOSIT LIST", "A", "C")

        # ==========================================================================
        # =-=-=-=-==-=-=-=-= N855T DEPOSIT LIST =-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-= 
        # ==========================================================================

        # N855T (DEPOSIT LIST) JIRAPORN
        safe_call(Fetch.deposit_list_PID, "f5x3n8v.com", "n855", "N855T", "THB", "+08:00", "N855T_DL", "1tJQJuy2-VsZ7u051fOAWjzsjFgP-9H7s25Z4NsVG6tA", "Deposit List", "A", "C")

        # N855T (DEPOSIT LIST) ARRIN
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "N855T_DL", "1jKBRkAyY-5PqOYmHgS_SqxWYY4C-JApDNc49YVGMSa8", "DEPOSIT LIST", "A", "C")
        ...
        # GT (DEPOSIT LIST) KOI
        safe_call(Fetch.deposit_list_PID, "gcwin99bo.com", "gc99", "GT", "THB", "+07:00", "GT_DL", "1fOWjL0KQa5Q7x2ApvFz2C3Mg-n1qM9yjeqrVcXn3hME", "Deposit List", "A", "C")

        # GT (DEPOSIT LIST) JIRAPORN
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "GT_DL", "1fpuWRQIT1_gR_636vFhFCDVWLx_aNDVqjYX8Ha9ENIM", "DEPOSIT LIST", "A", "C")

        # GT (DEPOSIT LIST) NOK
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "GT_DL", "16Wjf2lyJR4pwZXtKrf5fdycnAbdKvWvsUKSzUo7pNaM", "DEPOSIT LIST", "A", "C")

        # GT (DEPOSIT LIST) KOI
        safe_call(mongodb_2_gs.upload_to_google_sheet_DL_PID, "GT_DL", "1HTCzyiCgUy0CK_CVoup_8BLc8z93D7EYyA4jppaIi2U", "DEPOSIT LIST", "A", "C")
